...
class User(models.Model):
    ...
    full_name = models.CharField(max_length=100)  # Исправлено с 10 на 100
    role_id = models.CharField(max_length=10, choices=[  # Исправлено с 1 на 10
        ('admin', 'Администратор'),
        ('user', 'Пользователь')
    ], default='user')
    ...
    class Meta:
        # УБИРАЕМ managed = False чтобы Django управлял таблицей
...
class Animal(models.Model):
    ...
    sex = models.CharField(max_length=10, choices=[  # Исправлено с 1 на 10
        ('male', 'Жеребец'),
        ('female', 'Кобыла'),
        ('gelding', 'Мерин'),
        ('unknown', 'Не указан')
...
class Feed(models.Model):
    ...
    name = models.CharField(max_length=100)  # Исправлено с 10 на 100
