        ...
        <div class="main-content">
            ...
            <div class="card">
                ...
                <div class="upload-area" id="dropArea" onclick="document.getElementById('fileInput').click()">
                    ...
                    <div class="upload-subtext">Поддерживаемые форматы: MP4, AVI, MOV (до 500MB)</div>
                </div>
...
def run_lameness_analysis(video_id, video_path):
    ...
    try:
        ...
        if matches:
            ...
            add_analysis_log(video_id, "🎯 Результаты анализа получены")
            ...
            add_analysis_log(video_id, "❌ Не удалось получить результаты анализа")
            analysis_status[video_id] = {
                'status': 'failed',
        ...
        add_analysis_log(video_id, "⏰ Таймаут анализа: занял слишком много времени")
        analysis_status[video_id] = {'status': 'timeout', 'error': 'Анализ занял слишком много времени'}
    except Exception as e:
        add_analysis_log(video_id, f"❌ Ошибка анализа: {str(e)}")
